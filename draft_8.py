...
if choose_get_post == 1:
	...
	if method == "POST":
		...
		find_Content_Type = re.search(r"Content-Type",result1)
		find_Content_Length = re.search(r"Content-Length",result1)
		find_Origin = re.search(r"Origin",result1)
